...
export default function useExpenses() {
    ...
    const { data: allExpenses, mutate: mutatingExpenses, error: errorFetchingExpenses } = useSWR<Expenses[]>("/expenses?limit=20",
        async (url: string) => {
    ...
    const expenses = allExpenses ? allExpenses.slice(0, 50) : [];
